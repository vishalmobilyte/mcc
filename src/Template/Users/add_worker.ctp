          ...
          <div id="tab_1" class="tab-pane active">
				<div class="portlet box blue">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-user"></i>Add Worker </div>
							<div class="tools">
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
									  ...
									  <select class='form-control input-small' name="type_worker_id" id="type_worker" onchange="getLists(this)">
								...
								<div class="col-md-9 block_list" style="display:none;">
									<div class="form-group">
									  <label>Select RBSK Team <span class="required" >*</span>
									  </label>
									  <select class='form-control input-small' name="rbsk_team_id" id="block_id">
									  <option value="" >Select</option>
										 <?php 
