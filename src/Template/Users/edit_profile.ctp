										 ...
										 <?php 
										  if(!empty($country_info)){
											foreach($country_info as $cc_key=>$cc_val){
											  ?>
											  <option <?php if($user['country_code']==$cc_key){echo "selected"; }?> value='<?php echo $cc_key; ?>' data-image="<?php echo HTTP_ROOT; ?>img/blank.gif" data-imagecss="flag <?php echo strtolower($cc_val); ?>"><?php echo $cc_val; ?></option>
											  <?php
											}
										  }
										?>
