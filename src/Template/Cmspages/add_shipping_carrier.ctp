      ...
      <div class="portlet-body form">
        ...
        <div class="portlet box blue">
          <div class="portlet-title">
            <div class="caption">
              <i class="fa fa-user-secret"></i>Add shipping carrier</div>
              <div class="tools">
            ...
            <div class="portlet-body form">
              ...
              'url'    => ['controller' => 'cmspages', 'action' => 'add-shipping-carrier'],
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group" >
                    ...
                    <div >
                       <select class='form-control input-small' name="carrier_name" id="carrier_name">
						 <?php 
